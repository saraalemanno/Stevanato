...
# Delta from previous versions: Added a separate button to add the main device, removed this part from gpio_autoloop_test
# Author: Sara Alemanno
# Date: 2025-08-20
# Version: 8 to use with gpio_autoloop_test_v4 and I2C_test_v1 and encoder_test
...
<body>
    ...
    <script>
        ...
        async function addMainDevice() {
            ...
            consoleDiv.innerHTML += "<br><strong>Main Device Output:</strong><br>";
            try {
