...
import time
import requests
from I2C_test_v0 import run_I2C_test
...
def get_device_address():
    try:
        ...
        if 20 <= device_address <= 29:
            ...
            device_name = "Camere"
            deviceType = "C"
            return device_address, device_namespace, device_name, deviceType
...
if __name__ == "__main__":
    run_I2C_test(URL=URL_BACKEND)
    time.sleep(60)

    device_address, device_namespace, device_name, deviceType = get_device_address()
