...
from ArduinoController_v2 import start_encoder, stop_encoder, start_noise, stop_noise, init_serial, start_spi, stop_spi, reset_pins #clear_angles, 
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        ...
        for address_G in addresses_G:
            #clear_angles(ser)
            print("[BOTH]\n")
            run_galvo_test(address_G,ser) #rimosso il secondo argomento device
            time.sleep(20)
