...
# Date: 2025-08-06
# Version: 4 to use with gpio_autoloop_test_v2
    ...
    <script>
        ...
        function addDevice() {
            ...
            block.innerHTML = `
                ...
                <button class="run-test">Run Test GPIO</button>
            ...
            const runButtonGPIO = block.querySelector('.run-test');
            const device = [];
...
def run_test():
    ...
    script_path = 'gpio_autoloop_test_v2.py'  # Path to your script

    try: 
        process = subprocess.Popen(
            ['python', '-u', script_path, address] + pin_list,
