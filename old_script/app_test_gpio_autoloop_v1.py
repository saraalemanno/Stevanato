    ...
    <script>
        ...
        function addDevice() {
            ...
            block.innerHTML = `
                ...
                <label>Pin Numbers (e.g. 0 1 2 or ALL):</label><br>
        ...
        async function runTest() {
            ...
            document.getElementById('consoleOutput').value = result.output;
...
def run_test():
    ...
    print(f"[INFO] Received {len(devices)} devices for testing.")
    ...
    desktop_path = os.path.join(os.path.expanduser("~"), "Desktop", "GPIO_reports")
